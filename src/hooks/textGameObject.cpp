...
void TouchMacroGameObject::customObjectSetup(
    gd::vector<gd::string> &values, gd::vector<void *> &exists
) {
    TextGameObject::customObjectSetup(values, exists);
    TouchMacroGameObject::setupCustomTrigger();
};
void TouchMacroGameObject::updateTextObject(gd::string text, bool defaultFont) {
